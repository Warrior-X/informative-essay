        ...
        return (
            <div className="mx-auto w-2/3 text-black dark:text-white text">
                ...
                <ul className="list-decimal list-inside indent-8">
                    <li>
                        <a href="#what-are">What are Programming Langauges?</a>
                    </li>
                    <li>
                        <a href="#low-level">Low-Level Languages</a>
                    </li>
                    <li>
                        <a href="#high-level">High-Level Langauge</a>
                    </li>
                    <li>
                        <a href="#future">
                ...
                <Fig src="https://www.simplilearn.com/ice9/free_resources_article_thumb/Best-Programming-Languages-to-Start-Learning-Today.jpg" />
                <p>
                ...
                <p>
                    ...
                    classified as <a href="/glos#supercomputers">supercomputers</a> can help predict
                ...
                <p>
                    ...
                    languages must be converted, or <a href="/glos#compiler">compiled</a>, into
                ...
                <p>
                    ...
                    <a href="/glos#registers">registers</a>.{" "}
                </p>
                <p>
                ...
                <p>
                    ...
                    built-in <a href="/glos#data-structures">data structures</a>, such as a list or a
                    set. It is also easy to comprehend from either another
                    coder&apos;s perspective or from a person who does not
                    understand the <a href="/glos#syntax">syntax</a>(the words in the
                    language). For example, the code for displaying
                    the text “Hello World” is very simple.{" "}
                </p>
                <p>
                    This quality is called <a href="/glos#readability">readability</a>. However, the
                ...
                <p>
                    ...
                    today. According to Britannica, Java was created by <a href="/glos#sun-microsystems">Sun
                    Microsystems</a> in 1995. It was originally designed
                    to help the <a href="world-wide-web">World Wide Web</a>. It was equipped with
                ...
                <p>
                    ...
                    <a href="/glos#source-code">source code</a>, it is first compiled into a
