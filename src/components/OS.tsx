    ...
    render() {
        return (
            <div className="mx-auto w-2/3 text-black dark:text-white text">
                ...
                <h2 id="what-is-sys">Usage in Embedded Systems</h2>
                <p>
                ...
                <h1 id="parts">Parts of an Operating System</h1>
                <p>
                ...
                <h3 id="parts-kernel-exec">Program Execution</h3>
                <p>
                ...
                <h3 id="parts-kernel-mem">Memory Management</h3>
                <p>
                ...
                <h3 id="parts-kernel-sys">File Systems</h3>
                <p>
                ...
                <h2 id="parts-interface">User Interface</h2>
                <p>
                ...
                <h2 id="parts-app">Applications</h2>
                <p>
                ...
                <h1 id="popular">Popular Operating Systems</h1>
                <p>
                ...
                <h1 id="systems">Programs & Operating Systems</h1>
                <p>
                ...
                <h2 id="systems-programs">Porting Programs</h2>
                <p>
